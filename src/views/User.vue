<template>
    <div id="app" style="height: 1000px">
        ...
        <el-row :gutter="180">
            <el-col :span="4">
                <el-page-header @back="goBack" content="用户界面" style="margin-top: 10px; width: 300px">
                </el-page-header>
            </el-col>
        ...
        <el-container style="height: 700px; border: 1px solid #eee; margin-top: 30px">
            ...
            <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
                <el-menu router :default-openeds="['3']">
                    <el-submenu v-for="(item,index) in $router.options.routes" :index="index+''" v-if="item.usershow">
                        <template slot="title">{{item.name}}</template>
                        <el-menu-item v-for="(item2,index2) in item.children" :index="item2.path" v-if="item2.usershow"
...
<script>
    export default {
        ...
        methods: {
            ...
            personalInfo(){
                this.$router.push('/AccountUpdateForUser')
            },
        }
